...
<body class="bg-zinc-50 antialiased text-zinc-900 flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-64 bg-zinc-900 text-white transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 flex flex-col">
        ...
        <div class="p-4">
            ...
            <nav class="space-y-1">
                <a href="#" class="flex items-center gap-3 px-3 py-2.5 bg-theatre-red rounded-lg font-medium text-sm transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    Vue d'ensemble
                </a>
                <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-lg font-medium text-sm transition-colors">
        ...
        <div class="mt-auto p-4 border-t border-zinc-800">
            <a href="{{ route('home') }}" class="flex items-center gap-3 px-3 py-2.5 text-zinc-400 hover:text-white transition-colors text-sm font-medium">
