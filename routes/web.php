...
Route::post('/contact', [PageController::class, 'processContact'])->name('contact.submit');
...
// Routes Authentification Admin (GET/POST)
...
Route::prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::post('/medias', [App\Http\Controllers\MediaController::class, 'store'])->name('admin.medias.store');
